...
void GenerateD0SignalCandidates(Int_t nevents = 100000, 
				double Eint = 40., 
				const char *setup = "../setups/setup-EHN1_40GeV_5pixel.txt", 
				const char *filNamPow="/home/giacomo/na60fastsim/files/macros/pp0_frag-PtSpectra-Boost.root",
  ...
  TFile *fout = new TFile("D0-Signal-histos-D0.root", "recreate");
  ...
  TH1F *hCosp = new TH1F("hCosp", "", 300, -1, 1);
  TH2F *hCospvspt = new TH2F("hCospvspt", "", 300, -1, 1, 30, 0, 3);
  ...
  TH1D *hVz = new TH1D("hVz", "", 200, -0.5, 0.5);
  TH1F *hPx = new TH1F("hPx", "", 1000, -10, 10); // for Kaons
  TH1F *hPy = new TH1F("hPy", "", 1000, -10, 10);
  TH1F *hPz = new TH1F("hPz", "", 1000, 0, 20);
  ...
  if (writeNtuple)
    {
      fnt = new TFile("fntSig-D0.root", "recreate");
  ...
  TFile fout2("DecayHistos-D0.root", "RECREATE");
  // TFile fout2("DecayHistostest-D0.root", "RECREATE");
  hPtGen->Write();
  hptK->Write();
  hptPi->Write();
  hyK->Write();
...
void MakeD0CombinBkgCandidates(
				     const char *setup = "../setups/setup-EHN1_40GeV_5pixel.txt", 
  ...
  TFile *fout = new TFile("D0-Bkg-histos-D0.root", "recreate");
  ...
  Float_t arrnt[13];
  if (writeNtuple){
    fnt = new TFile("fntBkg-D0.root", "recreate");
    ntD0cand = new TNtuple("ntD0cand", "ntD0cand",  "mass:pt:y:dist:cosp:d01:d02:d0prod:dca:ptMin:ptMax:d0D:costhst", 32000);
  }
